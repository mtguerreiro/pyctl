...
class QP:
    ...
    def solve(self, xm, dx, xa, ui, D, Xp, r, Fj, y, solver='hild'):
        ...
        if solver == 'hild':
            ...
            du_opt, n_iters = self.cdmpc.solve(xm, dx, xa, ui, D, Xp, r)
...
class CDMPC:
    ...
    def solve(self, xm, dx, xa, ui, D, Xp, r):
